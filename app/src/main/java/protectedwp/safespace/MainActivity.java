...
public class MainActivity extends Activity {
    ...
    tv.setText("Hello! This is ProtectedWorkProfile app.\n" +
			...
			"This profile intended to protect any data in everyday life.\nEven if you ordinary user — this app is for you.\nBut be careful: don't connect phone to USB (PC, mouse, etc).\nAnd don't tap on Destroy🔥 button if you don't want delete data.\nDestroy🔥 button needed to quickly delete data in emergency situation, for example when you forced to show phone.\nYou can also enable extreme protection for such cases in AdditionalOptions.\nData wiping upon USB connection needed for protection against exploits.\n\n");
    scroll.addView(tv);
